...
SKIN.PrintName                                = "Github Derma Skin";
SKIN.Author                                   = "WLKRE";
SKIN.DermaVersion                             = 1;
SKIN.GwenTexture                              = Material("gwenskin/github.png");
...
SKIN.colTextEntryText                         = Color(201, 209, 217, 255);
SKIN.colTextEntryTextHighlight                = Color(24, 64, 116, 255);
SKIN.colTextEntryTextCursor                   = Color(201, 209, 217, 255);
SKIN.colTextEntryTextPlaceholder              = Color(169, 169, 169, 255);
